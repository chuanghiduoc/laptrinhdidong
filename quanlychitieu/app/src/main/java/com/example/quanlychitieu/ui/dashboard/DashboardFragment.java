...
public class DashboardFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // Load chart data - this would typically be implemented with a charting library
        setupExpenseChart();
    }
    ...
    private void setupExpenseChart() {
        // This would typically be implemented with a charting library like MPAndroidChart
        // For now, we'll just use the static layout
    }
